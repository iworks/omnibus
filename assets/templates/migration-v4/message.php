...
?>
		<div class="iworks-rate-buttons">
			<p><a href="<?php echo add_query_arg( 'page', 'omnibus-migration-v4', admin_url( 'tools.php' ) ); ?>" class="button button-primary" ><?php echo esc_html( __( 'Go to migration page', 'omnibus' ) ); ?></a></p>
		</div>
</div>
